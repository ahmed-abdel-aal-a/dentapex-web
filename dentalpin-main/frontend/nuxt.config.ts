...
export default defineNuxtConfig({
  ...
  app: {
    baseURL: process.env.NUXT_APP_BASE_URL || '/dentapex/',
    head: {
      title: 'DentApex',
      link: [
        { rel: 'icon', type: 'image/svg+xml', href: '/dentapex/favicon.svg' },
        { rel: 'manifest', href: '/dentapex/manifest.webmanifest' },
        { rel: 'apple-touch-icon', href: '/dentapex/logo-icon.svg' }
      ],
      meta: [
